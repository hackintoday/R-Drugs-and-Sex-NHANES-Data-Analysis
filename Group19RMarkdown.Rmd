...
m1 = lm(nlAvgSexFreq ~ SmokeNow+AlcoholYear+RegularMarij+HardDrugs+RegularMarij*HardDrugs+Age+Gender+HHIncome+Education, df)
df2 = df[-c(517, 928, 1454),]
m2 = lm(nlAvgSexFreq ~ SmokeNow+AlcoholYear+RegularMarij+HardDrugs+RegularMarij*HardDrugs+Age+Gender+HHIncome+Education, df2)
summary(m1)
summary(m2)
