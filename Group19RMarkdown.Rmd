...
Due to extreme skewness,  we tried to find some observations that had implausible reported data that could been a typo or non serious answer. For instance, given the age 9 was the lowest age at which first sexual activity occured among respondents, observations 8576 and 3416 reported to have had a first sexual activity at 9 with 360 and 500 sexual partners in life, respectively. Observations 4579 and 4580 reported to have had a first sexual activity at 10 and both reportedly had 700 sexual partners in life. Observations 4579 and 4580 reported to have had a first sexual activity at 10 and both reportedly had 700 sexual partners in life. 
```{R New variable}
hist(df$SexAge)
...
```{r multicolinearity}
#interactions(???)
nonintmodel <- lm(AvgSexFreq ~ Gender+HHIncome+Education+PhysActive+SameSex+AlcoholYear+RegularMarij+HardDrugs, df)
...
```{r remove outliers}
df2 = df[-which(df$SexNumPartnLife > 300),]
